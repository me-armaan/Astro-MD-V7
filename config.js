...
FOOTER: process.env.FOOTER === undefined ? '⏤͟͞ 𝐍𝐎𝐁𝐈𝐓𝐀 𓆩𓊈🇵🇰𓊉𓆪 ᴘᴜʙʟɪᴄ ꜱᴛᴀʙʟᴇ' : process.env.FOOTER,
CAPTION: process.env.CAPTION === undefined ? '*ɢᴇɴᴀʀᴀᴛᴇᴅ ʙʏ ⏤͟͞ 𝐍𝐎𝐁𝐈𝐓𝐀 𓆩𓊈🇵🇰𓊉𓆪*' : process.env.CAPTION,
...
SESSION_ID: process.env.SESSION_ID === undefined ? 'ASTRO=47AGDR4D#9ZzmcUKxIEjvtKm5Yw86ZhLjmPxSO0c7edKCFaHTS7Q' : process.env.SESSION_ID
};
